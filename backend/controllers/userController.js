...
// ✅ FIXED: Proper JWT token creation
...
export async function registerUser(req, res) {
    ...
    try {
        ...
        // ✅ Fixed status code from 2001 → 201 (Created)
        res.status(201).json({
            success: true,
            token,
...
export async function updateProfile(req, res) {
    ...
    try {
        ...
        // ✅ FIXED: Corrected method name from findbyInAndUpdate → findByIdAndUpdate
...
export async function updatePassword(req, res) {
    ...
    try {
        // ✅ FIXED: use req.user.id instead of registerUser.user.id
