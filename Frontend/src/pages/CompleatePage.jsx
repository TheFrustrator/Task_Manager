...
import {CT_CLASSES, SORT_OPTIONS} from '../assests/dummy'
          ...
          <div className={CT_CLASSES.sortBox}>
            ...
            <div className={CT_CLASSES.btnGroup}>
              {SORT_OPTIONS.map(opt => (
                ...
                className={[CT_CLASSES.btnBase,sortBy === opt.id ? CT_CLASSES.btnActive : CT_CLASSES.btnActive].join(" ")}>
                    {opt.icon}
                    {opt.label}
                </button>
              ))}
