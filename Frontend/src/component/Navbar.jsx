...
const Navbar = ({ user = { name: "User", email: "", avatar: "" }, onLogout }) => {
  ...
  const handleLogout = () => {
    setMenuOpen(false);
    if (onLogout) onLogout(); // ✅ Safely call onLogout if passed as prop
  };

  return (
    <header className="sticky top-0 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans z-50">
      <div className="flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto">
        ...
        >
          <div className="relative w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-fuchsia-500 via-purple-500 to-indigo-500 shadow-lg group-hover:shadow-purple-300/50 group-hover:scale-105 transition-all duration-300">
            ...
            <div className="absolute bottom-0 right-0 w-1.5 h-3 bg-white rounded-full shadow-md animate-ping" />
          </div>
