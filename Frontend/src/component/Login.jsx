...
import { BUTTON_CLASSES, INPUTWRAPPER } from './../assests/dummy';
...
const Login = ({ onSubmit, onSwitchMode }) => {
  ...
  const url = 'https://task-manager-edbm.onrender.com';
  ...
  return (
    <div className='max-w-md bg-white w-full shadow-lg border border-purple-100 rounded-xl p-8'>
      ...
      <div className='mb-6 text-center'>
        ...
        <p className='text-gray-500 text-sm mt-1'>Sign in to continue to Task Flow</p>
      </div>
